...
public class EmploiScraperTest {
    
    private EmploiScraper scraper;

    @BeforeEach
    void setUp() {
        scraper = new EmploiScraper();
    }
